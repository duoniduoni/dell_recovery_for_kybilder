...
def get_translations(languages=None, core_names=[], extra_prefixes=[]):
    ...
    if (_translations is None or languages is not None or core_names or
        ...
        prefixes = '|'.join((
            ...
            'partman-target/no_data',
            'partman-target/no_backup',
...
string_questions = {
    ...
    'partition_dialog_okbutton': 'ubiquity/imported/ok',
    'advanced_features_okbutton': 'ubiquity/imported/ok',
    'grub_fail_okbutton': 'ubiquity/imported/ok',
    'okbutton1': 'ubiquity/imported/ok',
    'okbutton2': 'ubiquity/imported/ok',
    'okbutton3': 'ubiquity/imported/ok',
}
