...
def kylin_check_passwd(passwd):
    from ubiquity import kylin_checkpasswd

    output = kylin_checkpasswd.check_pass(passwd)
    tmp_result = output.split(';')
    print("========================")
    print(tmp_result)
...
def gtk_password_validate(controller,
    ...
    if allow_empty:
        ...
        (txt, color) = kylin_check_passwd(passw)
